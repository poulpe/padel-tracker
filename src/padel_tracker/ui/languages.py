...
_DICT_TO_FR = {
    ...
    "user_added_error": "Oups, problème durant la création du compte",
...
_DICT_TO_EN = {
    ...
    "add_player_in_league": "Add player in league",
    ...
    "user_added_error": "Oops, an issue occurred during the account creation",
    ...
    "manage_my_league": "Manage my league",
    "description": "Description",
    "no_description_yet": "No description yet...",
    "add_in_league": "Recruit into the league",
    "add_existing_in_league": "Recruit existing player",
...
_DICT_TO_ES = {
    ...
    "manage_my_league": "Gestionar mi liga",
    "description": "Descripción",
    "no_description_yet": "Sin descripción por ahora...",
    "add_in_league": "Reclutar en la liga",
    "add_existing_in_league": "Reclutar existente jugador",
