...
#     player_id: UUID | None = Field(default=None, foreign_key="player.id", primary_key=True)
#     team_id: UUID | None = Field(default=None, foreign_key="team.id", primary_key=True)
#
# class TeamMatchLink(SQLModel, table=True):
#     team_id: UUID | None = Field(default=None, foreign_key="team.id", primary_key=True)
#     match_id: UUID | None = Field(default=None, foreign_key="match.id", primary_key=True)
